...
from lib.nav_planner import PIDController, RoutePlanner, interpolate_trajectory, EgoModel
...
class SEEDPilot(autonomous_agent.AutonomousAgent):
    def setup(self, conf_file, route_index=None):
        ...
        self.visualize = self.config.debug_print
        ...
        if self.config.save_data:
            ...
            self.save_path = Path(os.path.join(self.config.data_save, folder_name+time_now))
