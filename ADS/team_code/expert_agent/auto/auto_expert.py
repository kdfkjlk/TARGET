...
class Auto_Agent(AutonomousAgent):
    ...
    def run_step(self, input_data, timestamp):
        ...
        self.num_frames += 1
        if self.stop_counter>500 and self.config.force_destory_actor:
