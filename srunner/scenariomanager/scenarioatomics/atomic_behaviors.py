...
class VehicleLightStateSetter(AtomicBehavior):
    ...
    def __init__(self, actor, state, name="TrafficLightStateSetter"):
        ...
        Init
        """
        super(VehicleLightStateSetter, self).__init__(name)
    ...
    def update(self):
        ...
        new_status = py_trees.common.Status.RUNNING
        if self._actor.is_alive:
            self._actor.set_light_state(self._state)
            new_status = py_trees.common.Status.SUCCESS
        else:
...
class TrafficLightControl(AtomicBehavior):
    # RED = carla.TrafficLightState.Red
    # YELLOW = carla.TrafficLightState.Yellow
    # GREEN = carla.TrafficLightState.Green
    # OFF = carla.TrafficLightState.Off

    def __init__(self, traffic_lights, light_status, freeze=False, name="TrafficLightControl"):
        super(TrafficLightControl, self).__init__(name)
    ...
    def update(self):
        ...
        for traffic_light in self.traffic_lights:
            ...
            traffic_light.set_state(self.light_status)
            if self.freeze:
                traffic_light.freeze(True)
            else:
                if self.light_status == carla.TrafficLightState.Red:
                    traffic_light.set_red_time(20)
