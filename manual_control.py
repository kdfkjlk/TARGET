...
class World(object):
    ...
    def __init__(self, carla_world, hud, args):
        ...
        self.recording_enabled = args.recording
        self.recording_path = args.recording_path
    ...
    def restart(self):
        ...
        self.camera_manager = CameraManager(self.player, self.hud, self.recording_enabled, self.recording_path)
            ...
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    if (world.recording_enabled):
                        ...
                        client.start_recorder("/home/yao/Videos/manual_recording.rec")
...
class CameraManager(object):
    def __init__(self, parent_actor, hud, recording_enabled, recording_path):
        self.sensor = None
        self.surface = None
        self._parent = parent_actor
        self.hud = hud
        self.recording = recording_enabled
    ...
    def _parse_image(weak_self, image):
        ...
        if self.recording:
            ...
            # im.save("{}/{}.jpg".format(self.recording_path, image.frame))

            # image.save_to_disk('{}/{}'.format(self.recording_path, image.frame))
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            ...
            pygame.display.flip()
            imgdata = pygame.surfarray.array3d(display)
            imgdata = imgdata.swapaxes(0, 1)
            # print(imgdata.shape)
            im = Image.fromarray(imgdata)
            # im.save("{}/{}.jpg".format(args.recording_path, current_img_count))
            current_img_count += 1
...
def visualize_scenario(recording_path=None):
    time.sleep(3)
    main(recording_path)
